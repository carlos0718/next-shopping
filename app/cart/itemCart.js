			...
			<Grid container spacing={2}>
				...
				<Grid item xs={12} sm container>
					<Grid item xs container direction='column' spacing={2}>
						<Grid item xs>
							<Typography gutterBottom variant='subtitle1' color='#527ba5' component='div' sx={{fontWeight: 'bold'}}>
								{title}
							</Typography>
					...
					<Grid item>
						<span className='font-semibold text-gray-500'> Unit Price</span>
						<Typography variant='h6' component='div' className='text-gray-500 font-semibold'>
							${price * 1000}
						</Typography>
					</Grid>
				</Grid>
